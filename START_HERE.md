...
9. **禁止连续复用近期项目的中心语义。**近 7 个有效项目中已使用的品类、品牌名核心字、视觉隐喻和人格必须主动避让；不得连续围绕“灶、山野、火、院子”等同一语义换名字。
...
独立海报的多风格配额不得套用到 V4.1 十张品牌案例内部。`READY_TO_POST` 必须通过产品、文字、实际尺寸与 100% 检查。
