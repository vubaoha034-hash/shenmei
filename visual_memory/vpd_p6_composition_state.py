...
RF3_EXECUTE_ACTION = "EXECUTE_P4_RF3_HERITAGE_SINGLE_VARIABLE_EXACTLY_ONCE"
RF3_SETTLED_HOLD_ACTION = "HOLD_P4_RF3_SETTLED_PASS_NO_FURTHER_GENERATION"
RF4_REVIEW_ACTION = "REVIEW_P4_RF4_NONTOFU_HERITAGE_MATCHED_PAIR_DESIGN_NO_GENERATION"
RF4_EXECUTE_A_ACTION = "EXECUTE_P4_RF4_ROUTE_A_TRADITIONAL_RICE_EXACTLY_ONCE"
RF4_EXECUTE_B_ACTION = "EXECUTE_P4_RF4_ROUTE_B_CONTEMPORARY_RICE_EXACTLY_ONCE"
RF4_EVAL_ACTION = "RUN_P4_RF4_GOLDEN_ABSOLUTE_REALISM_GATES_AND_SETTLE"
RF4_SETTLED_HOLD_ACTION = "HOLD_P4_RF4_SETTLED_NO_FURTHER_GENERATION"
...
ACTIONS = {
    ...
    RF3_EXECUTE_ACTION,
    RF3_SETTLED_HOLD_ACTION,
    RF4_REVIEW_ACTION,
    RF4_EXECUTE_A_ACTION,
    RF4_EXECUTE_B_ACTION,
    RF4_EVAL_ACTION,
    RF4_SETTLED_HOLD_ACTION,
}
...
def validate_p6_composition_state(root):
    ...
    if action == RF4_SETTLED_HOLD_ACTION:
        require(lock.get("status") == "VPD_P4_RF4_MATCHED_PAIR_SETTLED_A_PASS_B_PASS_NO_FURTHER_GENERATION", "RF4_SETTLED_STATE")
        rf4=lock.get("p4_rf4_residual_causality_audit",{})
        require(rf4.get("status") == "SETTLED_A_PASS_B_PASS", "RF4_SETTLED_STATUS")
        require(rf4.get("current_budget") == {"authorized":2,"consumed":2,"remaining":0,"route_A":0,"route_B":0,"retry":0,"third_image":False}, "RF4_SETTLED_BUDGET")
        require(rf4.get("route_A_status") == "PASS_GOLDEN_ABSOLUTE_REALISM" and rf4.get("route_B_status") == "PASS_GOLDEN_ABSOLUTE_REALISM", "RF4_SETTLED_ROUTE_STATUS")
        require(rf4.get("causal_conclusion") == "GENERAL_HERITAGE_MAIN_EFFECT_NOT_SUPPORTED_IN_RICE__HERITAGE_X_TOFU_INTERACTION_MORE_PLAUSIBLE_NOT_PROVEN", "RF4_SETTLED_CAUSAL")
        check_ref(root,rf4["golden_evaluator_receipt"])
        check_ref(root,rf4["settlement"])
        er=read(root,rf4["golden_evaluator_receipt"]["path"])
        require(er["absolute_gates"]["A"]["ABSOLUTE_REALISM_GATE"] == "PASS" and er["absolute_gates"]["B"]["ABSOLUTE_REALISM_GATE"] == "PASS", "RF4_SETTLED_ABS_GATE")
        require(er["preregistered_combination"] == "A_TRADITIONAL_PASS__B_CONTEMPORARY_PASS", "RF4_SETTLED_COMBINATION")
        st=read(root,rf4["settlement"]["path"])
        require(st["status"] == "SETTLED_A_PASS_B_PASS", "RF4_SETTLEMENT_STATUS")
        require(st["budget_after"] == {"authorized":2,"consumed":2,"remaining":0,"retry":0,"third_image":False,"best_of_n":0,"reroll":0,"technical_failure_extra_budget":0}, "RF4_SETTLEMENT_BUDGET")
        require(st["nuisance_boundary"]["renderer_stochasticity_uncontrolled"] is True, "RF4_STOCHASTICITY_BOUNDARY")
        require(lock["execution_boundary"]["current_image_generation_authorization"] == 0 and lock["execution_boundary"]["current_figma_canvas_authorization"] == 0, "RF4_SETTLED_BOUNDARY")

    if action == RF4_EVAL_ACTION:
        require(lock.get("status") == "VPD_P4_RF4_MATCHED_PAIR_GENERATED_BOTH_VALID_WAITING_GOLDEN_GATES", "RF4_EVAL_STATE")
        rf4=lock.get("p4_rf4_residual_causality_audit",{})
        require(rf4.get("status") == "MATCHED_PAIR_GENERATED_BOTH_VALID_WAITING_GOLDEN_GATES", "RF4_EVAL_STATUS")
        require(rf4.get("current_budget") == {"authorized":2,"consumed":2,"remaining":0,"route_A":0,"route_B":0,"retry":0,"third_image":False}, "RF4_EVAL_BUDGET")
        require(rf4.get("route_A_status") == "TECHNICALLY_VALID_CONSUMED" and rf4.get("route_B_status") == "TECHNICALLY_VALID_CONSUMED", "RF4_EVAL_ROUTE_STATUS")
        check_ref(root,rf4["route_A_receipt"]); check_ref(root,rf4["route_B_receipt"])
        br=read(root,rf4["route_B_receipt"]["path"])
        require(br["technical_validity"]["verdict"] == "TECHNICALLY_VALID", "RF4_B_NOT_VALID")
        require(br["output"]["sha256"] == "bf8a46d04b904cbde4aa594bfbd3eaaa9cc318a089172ab422e9e292eac7d345", "RF4_B_HASH")
        require(lock["execution_boundary"]["current_image_generation_authorization"] == 0, "RF4_EVAL_AUTH_NOT_CLOSED")
        require(lock["execution_boundary"]["current_figma_canvas_authorization"] == 0, "RF4_EVAL_FIGMA_BOUNDARY")

    if action == RF4_EXECUTE_B_ACTION:
        require(lock.get("status") == "VPD_P4_RF4_ROUTE_A_TECHNICAL_VALID_B_READY", "RF4_B_READY_STATE")
        rf4=lock.get("p4_rf4_residual_causality_audit",{})
        require(rf4.get("status") == "ROUTE_A_TECHNICAL_VALID_B_READY", "RF4_B_READY_STATUS")
        require(rf4.get("current_budget") == {"authorized":2,"consumed":1,"remaining":1,"route_A":0,"route_B":1,"retry":0,"third_image":False}, "RF4_B_READY_BUDGET")
        require(rf4.get("route_A_status") == "TECHNICALLY_VALID_CONSUMED" and rf4.get("route_B_status") == "AUTHORIZED_READY", "RF4_B_SERIAL_STATE")
        check_ref(root,rf4["route_A_receipt"])
        ar=read(root,rf4["route_A_receipt"]["path"])
        require(ar["technical_validity"]["verdict"] == "TECHNICALLY_VALID", "RF4_A_NOT_VALID")
        require(ar["output"]["sha256"] == "f4a56280b0d14b00e75d54f42ed0447e50c24410e8c924cf50a916e764bac03e", "RF4_A_HASH")
        require(lock["execution_boundary"]["current_image_generation_authorization"] == 1, "RF4_B_CURRENT_AUTH")
        require(lock["execution_boundary"]["current_figma_canvas_authorization"] == 0, "RF4_B_FIGMA_BOUNDARY")

    if action == RF4_EXECUTE_A_ACTION:
        require(lock.get("status") == "VPD_P4_RF4_MATCHED_PAIR_AUTHORIZED_A_READY_B_BLOCKED", "RF4_AUTH_STATE")
        rf4=lock.get("p4_rf4_residual_causality_audit",{})
        require(rf4.get("status") == "MATCHED_PAIR_AUTHORIZED_A_READY_B_BLOCKED", "RF4_AUTH_STATUS")
        require(rf4.get("current_budget") == {"authorized":2,"consumed":0,"remaining":2,"route_A":1,"route_B":1,"retry":0,"third_image":False}, "RF4_AUTH_BUDGET")
        require(rf4.get("route_A_status") == "AUTHORIZED_READY" and rf4.get("route_B_status") == "SERIAL_BLOCKED_PENDING_A_TECHNICAL_VALID", "RF4_SERIAL_STATE")
        check_ref(root,rf4["generation_authorization"])
        a=read(root,rf4["generation_authorization"]["path"])
        require(a["status"] == "AUTHORIZED_A_READY_B_SERIAL_BLOCKED", "RF4_AUTH_DOC_STATUS")
        require(a["pair_integrity"]["only_text_difference"] == "WORKSHOP_SEMANTIC_SLOT", "RF4_PAIR_DIFF")
        require(a["authorization"] == {"total_images":2,"route_A_images":1,"route_B_images":1,"retry":0,"reroll":0,"best_of_n":0,"third_image":False,"technical_failure_extra_budget":0,"figma":0,"p5":False}, "RF4_AUTH_DOC_BUDGET")
        require(a["nuisance_boundary"]["causal_claim_ceiling"] == "DIRECTIONAL_SIGNAL_ONLY", "RF4_NUISANCE_BOUNDARY")
        require(lock["execution_boundary"]["current_image_generation_authorization"] == 1, "RF4_A_CURRENT_AUTH")
        require(lock["execution_boundary"]["current_figma_canvas_authorization"] == 0, "RF4_FIGMA_BOUNDARY")

    if action == RF4_REVIEW_ACTION:
        require(lock.get("status") == "VPD_P4_RF4_RESIDUAL_CAUSALITY_AUDIT_COMPLETE_WAITING_REVIEWER_GATE", "RF4_STATE")
        rf4=lock.get("p4_rf4_residual_causality_audit",{})
        require(rf4.get("status") == "AUDIT_COMPLETE_ONE_IMAGE_DESIGN_GAP_WAITING_REVIEWER_GATE", "RF4_STATUS")
        require(rf4.get("image_budget") == 0 and rf4.get("generation_performed") is False, "RF4_ZERO_BUDGET")
        require(rf4.get("generation_authorization") == 0, "RF4_PREMATURE_AUTH")
        require(rf4.get("one_image_design_gap") is True, "RF4_ONE_IMAGE_GAP")
        check_ref(root,rf4["audit"])
        d=read(root,rf4["audit"]["path"])
        require(d["single_variable_feasibility_audit"]["one_image_reuse_RF2_rice"]["verdict"] == "DESIGN_GAP", "RF4_ONE_IMAGE_REUSE_GAP")
        require(d["frozen_next_experiment_contract"]["status"] == "FROZEN_NOT_AUTHORIZED", "RF4_CONTRACT_STATUS")
        require(d["frozen_next_experiment_contract"]["only_variable"] == "HERITAGE_TRADITIONAL_SEMANTIC_SLOT", "RF4_VARIABLE")
        require(d["frozen_next_experiment_contract"]["future_minimum_budget"] == {"images":2,"arm_A":1,"arm_B":1,"retry":0,"third_image":False,"best_of_n":False,"reroll":False,"technical_failure_extra_budget":0}, "RF4_FUTURE_BUDGET")
        require(d["reviewer_gate"]["current_generation_authorization"] == 0, "RF4_REVIEW_AUTH")
        require(lock["execution_boundary"]["current_image_generation_authorization"] == 0 and lock["execution_boundary"]["current_figma_canvas_authorization"] == 0, "RF4_BOUNDARY")

    if action == RF3_SETTLED_HOLD_ACTION:
        require(lock.get("status") == "VPD_P4_RF3_HERITAGE_SINGLE_VARIABLE_SETTLED_PASS_NO_FURTHER_GENERATION", "RF3_SETTLED_STATE")
        rf3=lock.get("p4_rf3_causal_design_audit",{})
        require(rf3.get("status") == "SETTLED_PASS", "RF3_SETTLED_STATUS")
        require(rf3.get("current_budget") == {"authorized":1,"consumed":1,"remaining":0,"retry":0,"third_image":False}, "RF3_SETTLED_BUDGET")
        require(rf3.get("causal_conclusion") == "HERITAGE_X_TOFU_SEMANTIC_CONDITION_MECHANISM_STRONGLY_IMPLICATED_NOT_UNIQUE_CAUSE", "RF3_SETTLED_CAUSAL")
        require(rf3.get("renderer_prior_disproven") is False and rf3.get("heritage_unique_root_cause") is False, "RF3_OVERCLAIM")
        check_ref(root,rf3["authoritative_reviewer_receipt"])
        check_ref(root,rf3["settlement"])
        vr=read(root,rf3["authoritative_reviewer_receipt"]["path"])
        require(vr["gates"] == {"FIRST_IMPRESSION_AI_GATE":"PASS","DOCUMENTARY_CAUSALITY":"PASS","MATERIAL_HETEROGENEITY":"PASS","ABSOLUTE_REALISM_GATE":"PASS"}, "RF3_GATES")
        require(vr["confidence"] == 0.74, "RF3_CONFIDENCE")
        st=read(root,rf3["settlement"]["path"])
        require(st["budget_after"] == {"authorized":1,"consumed":1,"remaining":0,"retry":0,"third_image":False,"best_of_n":False,"reroll":False}, "RF3_SETTLEMENT_BUDGET")
        require(lock["execution_boundary"]["current_image_generation_authorization"] == 0 and lock["execution_boundary"]["current_figma_canvas_authorization"] == 0, "RF3_SETTLED_BOUNDARY")

    if action == RF3_EXECUTE_ACTION:
        require(lock.get("status") == "VPD_P4_RF3_HERITAGE_SINGLE_VARIABLE_AUTHORIZED_UNCONSUMED", "RF3_EXECUTE_STATE")
        rf3=lock.get("p4_rf3_causal_design_audit",{})
        require(rf3.get("status") == "HERITAGE_SINGLE_VARIABLE_AUTHORIZED_UNCONSUMED", "RF3_EXECUTE_STATUS")
        require(rf3.get("current_budget") == {"authorized":1,"consumed":0,"remaining":1,"retry":0,"third_image":False}, "RF3_EXECUTE_BUDGET")
        require(rf3.get("selected_next_variable") == "S1_HERITAGE_TRADITIONAL_SEMANTIC_PRIOR", "RF3_EXECUTE_VARIABLE")
        check_ref(root,rf3["generation_authorization"])
        a=read(root,rf3["generation_authorization"]["path"])
        require(a["status"] == "AUTHORIZED_UNCONSUMED", "RF3_AUTH_STATUS")
        require(a["authorization"] == {"images":1,"retry":0,"third_image":False,"best_of_n":False,"reroll":False,"technical_failure_extra_budget":0}, "RF3_AUTH_BUDGET")
        require(a["treatment"]["only_variable"] == "WORKSHOP_SEMANTIC_SLOT", "RF3_AUTH_VARIABLE")
        require(a["treatment"]["treatment_prompt_sha256"] == "553ff6459301bc6b858cb4339bfdc7be32d34124d6c27062c6ca55af7c3a9e51", "RF3_PROMPT_HASH")
        require(lock["execution_boundary"]["current_image_generation_authorization"] == 1, "RF3_EXECUTE_AUTH")
        require(lock["execution_boundary"]["current_figma_canvas_authorization"] == 0 and lock["execution_boundary"]["second_style_execution_allowed"] is False, "RF3_EXECUTE_BOUNDARY")
    ...
    if action == RF3_REVIEW_ACTION:
        ...
        rf3=lock.get("p4_rf3_causal_design_audit",{})
        require(rf3.get("status") == "AUDIT_COMPLETE_WAITING_REVIEWER_GATE", "RF3_STATUS")
        require(rf3.get("image_budget") == 0 and rf3.get("generation_performed") is False, "RF3_ZERO_BUDGET")
        require(rf3.get("rf2_cancelled_budget_reused") is False, "RF3_RF2_BUDGET_REUSE")
        check_ref(root,rf3["audit"])
        d=read(root,rf3["audit"]["path"])
        require(len(d["topic_conditioned_subvariables"]) >= 4, "RF3_SUBVARIABLE_COUNT")
        require(d["frozen_next_minimal_experiment"]["selected_variable"] == "S3_WET_HEAT_STEAM_ENVIRONMENT_PRIOR", "RF3_SELECTED_VARIABLE")
        require(d["frozen_next_minimal_experiment"]["proposed_budget"] == {"new_images_max":1,"retries":0,"third_image":False,"best_of_n":False,"reroll":False,"technical_failure_extra_budget":0}, "RF3_BUDGET")
        require(d["reviewer_gate"]["generation_authorization"] == 0, "RF3_PREMATURE_AUTH")
        require(d["budget_boundary"]["rf2_cancelled_second_image_reusable"] is False, "RF3_BUDGET_BOUNDARY")
        require(lock["execution_boundary"]["current_image_generation_authorization"] == 0 and lock["execution_boundary"]["current_figma_canvas_authorization"] == 0, "RF3_EXECUTION_BOUNDARY")

    if action == RF2_STAGE1_PASS_STOP_ACTION:
        require(lock.get("status") == "VPD_P4_RF2_STAGE1_ABSOLUTE_REALISM_PASS_STOP_STAGE2_PROHIBITED", "RF2_STAGE1_PASS_STATE")
        rf2 = lock.get("p4_rf2_causal_design_audit", {})
        require(rf2.get("status") == "SETTLED_STAGE1_PASS_STAGE2_PROHIBITED", "RF2_STAGE1_PASS_STATUS")
        require(rf2.get("budget") == {"maximum":2,"consumed":1,"cancelled_unconsumed":1,"retry":0,"third_image":False}, "RF2_STAGE1_PASS_BUDGET")
        require(rf2.get("stage2", {}).get("allowed") is False, "RF2_STAGE2_REOPENED")
        require(rf2.get("causal_conclusion") == "TOPIC_CONDITIONED_MECHANISM_FAMILY_STRONGLY_IMPLICATED", "RF2_STAGE1_CAUSAL")
        require(rf2.get("unique_cause_claim_allowed") is False, "RF2_UNIQUE_CAUSE_OVERCLAIM")
        for name in ("stage1_evaluator_receipt","stage1_settlement"):
            check_ref(root, rf2[name])
        er=read(root,rf2["stage1_evaluator_receipt"]["path"])
        require(er["gates"] == {"FIRST_IMPRESSION_AI_GATE":"PASS","DOCUMENTARY_CAUSALITY":"PASS","MATERIAL_HETEROGENEITY":"PASS","ABSOLUTE_REALISM_GATE":"PASS"}, "RF2_STAGE1_GATES")
        require(er["stop_decision"] == "STOP_STAGE1_PASS_STAGE2_PROHIBITED", "RF2_STAGE1_STOP")
        require(lock["execution_boundary"]["current_image_generation_authorization"] == 0 and lock["execution_boundary"]["current_figma_canvas_authorization"] == 0, "RF2_STAGE1_PASS_BOUNDARY")
    ...
    if action == RF2_AUDIT_GATE_ACTION:
        ...
        rf2 = lock.get("p4_rf2_causal_design_audit", {})
        require(rf2.get("status") == "AUDIT_COMPLETE_WAITING_REVIEW_GATE", "RF2_AUDIT_STATUS")
        require(rf2.get("image_budget") == 0 and rf2.get("generation_performed") is False, "RF2_AUDIT_ZERO_BUDGET")
        require(rf2.get("future_design", {}).get("maximum_new_images") == 2, "RF2_MAX_BUDGET")
        require(rf2.get("future_design", {}).get("retry_budget") == 0 and rf2.get("future_design", {}).get("third_image") is False, "RF2_BUDGET_BOUNDARY")
        require(rf2.get("standing_authorization_auto_continue") is False, "RF2_PREMATURE_AUTOAUTH")
        check_ref(root, rf2["audit"])
        doc = read(root, rf2["audit"]["path"])
        require(doc["correction_to_rf1_interpretation"]["accepted_strict_conclusion"] == "R1C_NOT_NECESSARY", "RF2_RF1_SCOPE")
        require(doc["correction_to_rf1_interpretation"]["prohibited_overclaim"] == "DO_NOT_CLAIM_RENDERER_PRIOR_PROVEN_PRIMARY", "RF2_OVERCLAIM_GUARD")
        require(doc["minimal_future_design"]["maximum_new_images"] == 2 and doc["minimal_future_design"]["retry_budget"] == 0, "RF2_DESIGN_BUDGET")
        require(doc["minimal_future_design"]["stage_1"]["only_variable"] == "TOPIC_CONTENT_SLOT", "RF2_STAGE1_VARIABLE")
        require(doc["minimal_future_design"]["stage_2_conditional"]["only_variable"] == "TASK_STRUCTURE", "RF2_STAGE2_VARIABLE")
        require(doc["audit_gate"]["current_self_audit"] == "PASS", "RF2_SELF_AUDIT")
        require(doc["authorization_boundary"]["future_generation_budget_authorized"] is False, "RF2_PREMATURE_GENERATION_AUTH")
        require(lock["execution_boundary"]["current_image_generation_authorization"] == 0 and lock["execution_boundary"]["current_figma_canvas_authorization"] == 0, "RF2_EXECUTION_BOUNDARY")
        require(lock.get("p6_allowed") is False and lock.get("render_allowed") is False, "RF2_PREMATURE_OPEN")
